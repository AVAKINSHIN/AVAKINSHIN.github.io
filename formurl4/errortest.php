...
$errors = FALSE;
  ...
  if (!preg_match('~@~', $_POST['email']) || empty($_POST['email']) || !filter_var($_POST['email'], FILTER_VALIDATE_EMAIL))
  {
       ...
       {
           setcookie('email_error', 'Email должен соответствовать формату X@Y.Z', time() + 24 * 60 * 60);                                                          }                                                                                                                                                           $errors = TRUE;                                                                                                                                        }                                                                                                                                                           if (empty($_POST['year'])||!is_numeric($_POST['year'])||!preg_match('/^\d+$/', $_POST['year'])||intval($_POST['year'])<1900||intval($_POST['year'])>2025)   {                                                                                                                                                                     if (empty($_POST['year']))                                                                                                                                  {                                                                                                                                                                   setcookie('year_error', 'Поле год рождения не должно быть пустым.', time() + 24 * 60 * 60);                                                         }                                                                                                                                                           elseif (!is_numeric($_POST['year'])||!preg_match('/^\d+$/', $_POST['year']))                                                                                {                                                                                                                                                                   setcookie('year_error', 'Поле год рождения должно быть в числовом формате в диапазоне от 1900 до 2025.', time() + 24 * 60 * 60);                    }                                                                                                                                                           elseif (intval($_POST['year']) < 1900)                                                                                                                      {                                                                                                                                                                   setcookie('year_error', 'Не верю, что вы смогли прожить так долго. Попробуйте ещё раз (минимальный год - 1900)', time() + 24 * 60 * 60);            }
            else
            {
